...
<head>
  ...
  <meta name="description" content="Cakdun Site">
  <meta name="keywords" content="Jasa website Yogyakarta, cakdun site, developer,website terkini,jasa, website, Responsive, website murah">
  <meta name="author" content="Cakdun Site">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>Cakdun Site</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#gallery">Portofolio</a></li>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Bangun Website Anda di <span>Cakdun Site</span></h1>
            <h2>Kami Memberikan penawaran Terbaik untuk anda</h2>
